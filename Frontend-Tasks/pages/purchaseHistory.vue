                        ...
                        <ul class="mx-5px">
                            ...
                            <v-container id="table">
                                <v-data-table :loading="loading" :headers="headers" :items="products" :footer-props="{
                                    ...
                                    :sort-desc.sync="sortDesc" @update:sort-desc="purchaseHistory">
    ...
    data() {
        return {
            ...
            headers: [
                ...
                { text: "TID", value: "TID", sortable: true },
                { text: "Product ID", value: "product_id", sortable: true },
                { text: "Original Transaction ID", value: "original_transaction_id", sortable: true },
                { text: "Order ID", value: "payment_purchased_id", sortable: true },
                { text: "User ID", value: "purchased_by", sortable: true },
        ...
        async purchaseHistory() {
            try {
                ...
                const { data } = await this.$axios.get(
                    `api/seller/purchases-history?page=${this.page}&perPage=${this.perPage}&sortBy=${this.sortBy}&desc=${this.sortDesc}`
                );
